...
// 
//------------------------------------------------------------------------------
// Function: appeon_nvo_db_update::of_isvalid_dwo
//------------------------------------------------------------------------------
// Description:
//		Detects if the passed-in object is a DataWindow, DataStore, or DataWindowChild. 
// 
// Arguments: 
//			powerobject		obj : PB object.
//			
//	
// Returns: integer
//					 1 - It is a DataWindow, DataStore, or DataWindowChild.
//					-1 - It is none of the three objects.
//------------------------------------------------------------------------------
// Author:	APPEON		Date: 2017-03
//------------------------------------------------------------------------------
// Revision History: 
//				1.0   Initial version
//==============================================================================

IF  (TypeOF(obj) <> DataWindow! AND TypeOF(obj) <> DataStore! AND TypeOF(obj) <> DataWindowChild!) THEN
	RETURN -1
End IF
RETURN 1
end function
